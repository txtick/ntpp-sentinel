...
- Opening the dashboard while signed out now shows a dedicated Sentinel login page instead of an empty dashboard frame. The dashboard appears only after Google sign-in succeeds.
