...
- When a dashboard session expires, any unauthorized API response or return to the foreground must hide the application shell and show the branded sign-in page again.
